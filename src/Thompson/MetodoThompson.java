...
public class MetodoThompson {
    ...
    public void AFND_Graphviz() {
        ...
        File directorio = new File(directoryName + "/AFND_202003919");
        ...
        ProcessBuilder pb;
        if (lista == null) {
            f = new File(directoryName + "/AFND_202003919/afnd.dot");
            numero = -1;
            ...
            if (lista.length == 0) {
                ...
                f = new File(directoryName + "/AFND_202003919/afnd" + lista.length + ".dot");
                numero = lista.length;
            }
        }
        ...
        try {
            ...
            if (numero == -1) {
                pbuilder = new ProcessBuilder("dot", "-Tpdf", "-o", directoryName + "/AFND_202003919/afnd.pdf", directoryName + "/AFND_202003919/afnd.dot");

            } else {
                pbuilder = new ProcessBuilder("dot", "-Tpdf", "-o", directoryName + "/AFND_202003919/afnd" + numero + ".pdf", directoryName + "/AFND_202003919/afnd" + numero + ".dot");
            }
